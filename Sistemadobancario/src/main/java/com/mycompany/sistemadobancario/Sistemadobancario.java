...
private static void investir(ContaCorrente conta) {
    ...
    System.out.println("Informe o tempo (em anos) para o investimento: ");
    ...
    switch (escolha) {
        case 1 -> {
            ...
            retorno = ContaInvestimento.LCI.calcularRetorno(valor, tempo); 
        }
        case 2 -> {
            tipoInvestimento = "LCA";
            retorno = ContaInvestimento.LCA.calcularRetorno(valor, tempo); 
        }
        case 3 -> {
            tipoInvestimento = "CRI";
            retorno = ContaInvestimento.CRI.calcularRetorno(valor, tempo); 
        }
        default -> {
            System.out.println("Opção inválida.");
            return;
    ...
    System.out.println("Investimento realizado! Retorno estimado após" +tempo + "ano: R$" + retorno);
